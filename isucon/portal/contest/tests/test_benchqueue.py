...
class JobTest(TestCase):
    ...
    def test_done(self):
        ...
        job3.done(result={"score": 100, "pass": True}, stdout="blah\nblah\nblah", stderr="blah\nblah\nblah")
    ...
    def test_duplicate_enqueue(self):
        ...
        # 成功すれば、再度ジョブ登録が可能
        job.done(result={"score": 100, "pass": True}, stdout="", stderr="")
        ...
        job2.abort(result={"score": 100, "pass": True}, stdout="", stderr="")
    ...
    def test_of_team(self):
        ...
        for idx in range(11):
            job_id = Job.objects.enqueue(self.team)
            job = Job.objects.get(pk=job_id)
            job.done(result={"score": idx, "pass": True}, stdout="logloglog", stderr="logloglog")
